...
// C code that demonstrates the difference between calloc and malloc

int main()
{
	// Both of these allocate the same number of bytes,
	// which is the amount of bytes that is required to store 5 int values.
	...
	// This malloc requests 1 terabyte of dynamic memory, which is unavailable in this case, and so the
